...
class pptx_parser:
    ...
    def extract_text_from_presentation(self) -> None:
       ...
       """
        for slide_number, slide in enumerate(self.presentation.slides):
            slide_text = pptx_parser.extract_text_from_slide(slide)
    ...
    def extract_text_from_slide(current_slide) -> str:
        ...
        """
        return ''.join([pptx_parser.extract_text_from_shape(shape) for shape in current_slide.shapes])
    ...
    def extract_text_from_shape(shape):
        ...
        """
        return ''.join(
            [pptx_parser.extract_text_from_paragraph(paragraph) for paragraph in
